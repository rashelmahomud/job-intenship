...
const Navber = () => {
    ...
    return (
        <div className='w-full fixed top-0 left-0 bg-red-50'>
            <div className='lg:flex items-center justify-between py-4 lg:px-10 px-10'>
                ...
                <ul className={`lg:flex md:items-center md:pb-3 pb-12 absolute lg:static lg:z-auto z-[-1] left-0 w-fulllg:w-auto lg:pl-0 pl-9 transition-all duration-500 ease-in ${open ? 'top-18 opacity-100' : "top-[-490] lg:opacity-100 opacity-0"}`}>
